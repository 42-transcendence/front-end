...
export function RoundButtonBase({
    ...
    return (
        <button
            ...
            {...props}
        >
            <div className="gradient-border back-full group relative flex w-80 flex-col items-start gap-2 rounded-[28px] border-transparent bg-windowGlass/30 p-px px-5 py-4 backdrop-blur-[50px] transition-colors before:pointer-events-none before:rounded-[28px] before:p-px before:backdrop-brightness-100 hover:bg-primary focus:outline-2 focus:outline-gray-100 focus:ring focus:ring-violet-300 active:bg-violet-700 hover:dark:border-purple-700 hover:dark:bg-neutral-800/30">
