...
export default function LoginPage() {
    return (
        <section>
            <div className="relative flex h-screen w-screen flex-col items-center justify-center gap-20">
                ...
                <div className="relative flex h-[50%] w-fit flex-col items-center justify-center gap-1 py-10">
                    <GoogleLoginButton />
                    <FtLoginButton />
                </div>
            </div>
