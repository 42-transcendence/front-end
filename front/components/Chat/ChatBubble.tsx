...
function ChatBubble({
    ...
    return (
        ...
        >
            ...
            <span
                className={`static h-fit min-h-[1rem] w-fit min-w-[3rem] max-w-xs break-all rounded-xl ${styleOption.bgColor} p-3 font-sans text-base font-normal text-gray-100/90`}
            >
                {children}
            </span>
        </div>
