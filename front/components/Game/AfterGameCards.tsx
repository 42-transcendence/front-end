...
export function PlayAgainCard() {
    return (
        <>
            <div className="flex items-center justify-between rounded-[2.5rem] bg-black/50 px-8 lg:py-6">
                <div className="flex flex-row items-center justify-center py-[1rem] lg:flex-col">
...
export function NewAchievementCard() {
    return (
        <div className="flex items-center justify-between rounded-[2.5rem] bg-black/50 px-8 lg:py-6">
            <div className="flex shrink-0 flex-row items-center justify-center py-[1rem] lg:flex-col">
...
export function TrophyCard() {
    return (
        <div className="inline-flex flex-col items-center justify-center gap-[2rem] rounded-[2.5rem] bg-white/10 px-4 py-4">
            {/* star icon */}
            <div className="flex items-center gap-[2.5rem] px-20 py-4">
                <div className="h-px w-[4.5rem] bg-white"></div>
            ...
            <Image
                ...
                height="300"
            />
            <div className="m-6 flex flex-col items-center justify-center rounded-[2rem] bg-black/40 px-5 py-6">
                ...
                <div className="my-5 h-0.5 w-[5rem] bg-white"></div>
