...
import ChattingRoomBlock from "./ChattingRoomBlock";
import "./style.css";
...
export default function ChattingSideBar() {
    return (
        <div>
            <div className="h-fill float-left flex shrink-0 flex-col items-start gap-2 rounded-[0px_28px_28px_0px] p-4 backdrop-blur-[50px]">
                ...
                {/* {chatRoomsDummy.map((elem) => (
                    ...
                    <ChattingRoomBlock key={elem.id} {...elem}/>
                ))} */}
