...
export function TextField({
    ...
    return (
        <div className="shadow-3xl group relative flex h-8 shrink-0 items-center justify-between gap-2 self-stretch rounded-xl bg-black/30 py-1 pl-7 pr-2 transition-all focus-within:pl-2">
